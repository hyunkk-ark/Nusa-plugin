...
public abstract class SqlCommonAdapter<T extends ISqlCommonConfig> implements IDataSourceAdapter<T> {
    ...
    public void patch() {
        ...
        try (var conn = ds.getConnection()) {
            Slimefun.logger()
                    .log(Level.INFO, "Updating database version to " + patch.getVersion() + ", it may take a while...");
            ...
            Slimefun.logger().log(Level.SEVERE, "There was a problem updating the database!", e);
        }
    }
}
