...
/**
 * Abstract class for Slimefun data container.
 * <p>
 * This class is used to store Slimefun-specific data containers, including Slimefun ID and a flag to be deleted.
 *
 * @author NoRainCity
 *
 * @see ADataController
