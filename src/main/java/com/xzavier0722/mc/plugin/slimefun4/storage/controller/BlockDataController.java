 ...
 * <p>
 * Used to manage Slimefun block data in blocks
 * <p>
...
public class BlockDataController extends ADataController {
    ...
    /**
     * Global controller loads data lock
     *
     * {@link ScopedLock}
     */
     ...
     *
     *{@link IDataSourceAdapter}used by@paramdataAdapter
     *@parammaxReadThread maximum number of database reading threads
     *@parammaxWriteThread maximum number of database write threads
     */
    @Override
    ...
    /**
     * Load data from all worlds the server has loaded
     */
    ...
    /**
     * Load data from all world blocks loaded by the server
     */
    ...
    /**
     * Initialize delayed loading task
     *
     *@paramp plug-in example
     *@paramdelayedSecond first execution delay
     *@paramforceSavePeriod force save period
     */
     ...
     *
     *@paraml Slimefun block position{@link Location}
     *@paramsfId Slimefun Item ID{@link SlimefunItem#getId()}
     *@returnblock data,{@link SlimefunBlockData}
     */
    @Nonnull
    ...
    /**
     * Create a new Slimefun generic data
     * <br/>
     * Provide a KV storage Map for reading and writing
     *
     *@paramsfId Slimefun Item ID{@link SlimefunItem#getId()}
     *@returngeneral data,{@link SlimefunUniversalData}
     */
    @Nonnull
     ...
     * Provide a KV storage Map for reading and writing
     *
     *@paramuuid Universal data identification UUID
     *@paramsfId Slimefun Item ID{@link SlimefunItem#getId()}
     *@returngeneral data,{@link SlimefunUniversalData}
     */
    @Nonnull
     ...
     *@paraml Slimefun block position{@link Location}
     *@paramsfId Slimefun Item ID{@link SlimefunItem#getId()}
     *@returngeneral block data,{@link SlimefunUniversalBlockData}
     */
    @Nonnull
    ...
    /**
     * Immediately plan to save a common data
     *
     *@paramuniversalData is to write the universal data saved in the database
     */
    ...
    /**
     * Remove Slimefun data at the specified location
     *
     *@paraml Position{@link Location}
     */
    ...
    /**
     * Remove the Slimefun block data at the specified position
     *
     *@paraml Position{@link Location}
     */
    ...
    /**
     * Remove possible Slimefun general block data corresponding to the specified location
     *
     *@paraml{@link Location}location
     */
    ...
    /**
     * Remove the Slimefun general block data corresponding to the specified UUID
     *
     *@paramuuid universal block data identifier
     */
    ...
    /**
     * Get{@link SlimefunUniversalData}from cache
     *
     *@paramuuid universal data UUID
    ...
    public void loadWorld(World world) {
        ...
        logger.log(Level.INFO, "Finished loading data for world {0} in {1} ms.", new Object[] {
    ...
    public void loadUniversalData(SlimefunUniversalData uniData) {
        ...
        // Construct general data kv storage query conditions
        ...
        try {
            ...
            if (uniData instanceof SlimefunUniversalBlockData ubd) {
                if (ubd.hasTrait(UniversalDataTrait.BLOCK)) {
                    // Initialize the last occurrence position
    ...
    /**
     * Migrate old Slimefun machine data to common data
     */
    private void migrateUniversalData(
        ...
        try {
            ...
            Slimefun.logger().log(Level.WARNING, "An error occurred while migrating robot data", e);
        }
    }
}
