...
public class SlimefunItem implements Placeable {
     ...
     *
     * Return to the unofficial Chinese Wiki address
     * Downstream should use{@link SlimefunItem#addWikiPage(String)}to add wiki pages
     *
     * @param page
    ...
    /**
     * Specify the wiki page for this item
     *
     *@parampage Wiki page of the item
     */
        ...
        if (addon == null) {
            Slimefun.logger()
                    .warning("The item\"" + getId()
                            + "\"has not been registered yet. Please add the Wiki page after registering the item.");
            return;
        }
