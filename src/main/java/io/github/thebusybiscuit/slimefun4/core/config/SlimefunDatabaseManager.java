        ...
        try {
            ...
            if (readExecutorThread + writeExecutorThread > connectionPoolSize) {
                plugin.getLogger()
                        .log(
                                Level.WARNING,
                                "It is detected that the block-storage connection pool size configuration is smaller than the sum of read and write threads, which may cause performance issues.");
            }
        ...
        try {
            ...
            if (readExecutorThread + writeExecutorThread > connectionPoolSize) {
                plugin.getLogger()
                        .log(
                                Level.WARNING,
                                "It is detected that the profile-storage connection pool size configuration is smaller than the sum of read and write threads, which may cause performance issues.");
            }
