...
public final class SlimefunItems {
    ...
    /**
     * Smart input/output interface used by the maintained fork's auto-crafter implementation.
     */
    public static final SlimefunItemStack CRAFTER_SMART_PORT = new SlimefunItemStack(
            ...
            "&aCrafter Smart Port",
            "",
            "&5Distributes inputs according to the recipe",
            "&5and provides a designated output slot");
