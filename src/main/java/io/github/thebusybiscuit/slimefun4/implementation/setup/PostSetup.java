...
public final class PostSetup {
    ...
    public static void setupWiki() {
        Slimefun.logger().log(Level.INFO, "Loading wiki page...");
    ...
    public static void loadItems() {
        ...
        sender.sendMessage(ChatColor.GREEN + " - Issues: https://github.com/SlimefunGuguProject/Slimefun4/issues");
